...
export default function MenuBar() {
  ...
  return (
    <div className="hidden md:flex fixed top-0 left-0 right-0 h-7 z-[9999] items-center justify-between px-4 bg-black/30 backdrop-blur-xl border-b border-white/10">
      {/* Left side */}
